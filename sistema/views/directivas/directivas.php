...
public function upload_file($cols=12, $campo=false, $ln=false){
    ...
    public function editortexto($value="", $cols, $campo){
        $campo_capitalize = $this->genera_texto_etiqueta($campo);

        $html ="<div class='form-group box-body pad col-md-$cols'>

                <textarea id='editor1' class='form-control edittextarea' row='10' name='$campo' placeholder='Ingresa $campo_capitalize'
                    title='Ingrese $campo_capitalize'>$value
                </textarea>
    ...
    public function checkboxDia($checked="", $cols, $campo ){
        $campo_capitalize = $this->genera_texto_etiqueta($campo);
     ...
     public function hora($value="", $cols, $campo){
        $campo_capitalize = $this->genera_texto_etiqueta($campo);

        $html = "
           <div class='form-group col-md-$cols'>      
                <label for='$campo'>$campo_capitalize:</label>
                <input class='form-control' type='time' name='$campo' placeholder='Ingresa $campo_capitalize' 
                    title='Ingrese $campo_capitalize' value='$value'></input>
            </div>
    ...
    public function header($link){
        $html = $html."<header class='main-header'>
